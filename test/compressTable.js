...
var table = {
  'header': [
    ...
    { 'name': 'latitude', 'type': 'int', 'transform': { 'offset': -43, 'multip': -1000000, 'sequence': true } },
    { 'name': 'longitude', 'type': 'int', 'transform': { 'decimals': 6, 'sequence': true } },
  ...
  'data': [
    ...
    ['big tree', 9327924, -42.555425, 173.60413, 32],
